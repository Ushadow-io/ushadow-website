...
const coreFeatures = [
  {
    ...
    tagline: 'Drag-and-Drop Provider Configuration',
    description: 'Wire services together visually. Drag providers to capabilities, create model instances, and see your entire architecture at a glance. No complex configuration files required.',
    features: [
      'Visual drag-and-drop interface for service wiring',
      'Connect providers (OpenAI, Anthropic) to capabilities',
      'Create and manage model instances (GPT-5, Claude, etc.)',
      'Real-time architecture visualization',
      'Auto-generated configuration from visual layout',
    ],
    status: 'Core',
    statusColor: 'primary',
    link: '/docs',
    screenshot: '/screenshots/wiring.png',
  },
  {
    id: 'multi-worktree',
    name: 'Multi-Worktree Development',
    tagline: 'Color-Coded Isolated Environments',
    description: 'Run multiple Ushadow environments simultaneously. Each workspace gets its own color-coded VS Code instance (red, purple, green, gold), containers, and configuration for parallel development and testing.',
    features: [
      'Multiple isolated Ushadow instances side-by-side',
      'Color-coded VS Code windows for easy identification',
      'Independent container environments per workspace',
      'Separate YAML configs for each worktree',
      'Test integrations without affecting main environment',
    ],
    status: 'Core',
    statusColor: 'accent',
    link: '/docs',
    screenshot: '/screenshots/worktrees.png',
  },
  {
    id: 'recording',
    name: 'Meeting & Conversation Recording',
    tagline: 'Chronicle + Omi Mobile App',
    description: 'Record meetings with Chronicle browser extension and capture conversations anywhere with the Omi mobile app. Connect via QR code, see live waveforms, browse memories, and search transcribed conversations.',
    features: [
      'Chronicle browser extension for meeting recording',
      'Omi mobile app with QR code connection',
      'Live audio waveforms during recording',
      'Browse conversation memories in-app',
  ...
  },
  {
    ...
    tagline: 'Auto-Detected Add-ons',
    description: 'Drop a compose file into the service registry and it auto-detects. Wizard-guided configuration makes deployment instant. No manual manifest editing required.',
    features: [
      'Drag-and-drop compose files for instant detection',
      'Auto-discovery of service capabilities',
      'Wizard-guided configuration interface',
      'One-click deployment to any Unode',
  ...
  },
  {
    ...
    description: 'Integrate with external tools and data sources. Connect your Obsidian vault, transform data on-the-fly, and build custom integrations. Hackable by design.',
    features: [
      'Obsidian Vault integration for knowledge management',
      'Custom data transformations and pipelines',
